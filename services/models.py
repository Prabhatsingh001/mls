...
class Service(models.Model):
    ...
    base_price = models.DecimalField(max_digits=10, decimal_places=2, help_text="Standard rate for this job")
...
class Project(models.Model):
    ...
    source_request = models.OneToOneField(JobRequest, on_delete=models.CASCADE, related_name='project')
    ...
    def __str__(self):
        return f"PRJ-{self.pk}: {self.source_request.service.title}"