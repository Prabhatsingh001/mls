...
urlpatterns = [
    ...
    path("verify-phone-otp/<int:user_id>/", views.verify_phone_otp, name="verify-phone-otp"),
    path("resend-phone-otp/<int:user_id>/", views.resend_phone_otp, name="resend-phone-otp"),
